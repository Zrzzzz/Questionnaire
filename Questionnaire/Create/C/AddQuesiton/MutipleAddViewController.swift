//
//  MutipleAddViewController.swift
//  Questionnaire
//
...
class MutipleAddViewController: FormViewController {
        ...
        form +++
            ...
            +++ ButtonRow() {
                ...
                if let title = (self.form.rowBy(tag: "title") as! TextRow).value,
                    ...
                    let multi = Multiple(id: UUID().uuidString, question: title, options: self.getOptions(), rightAnswer: self.getRightAns(), random: 0, necessary: self.getNess(), score: score)

...
class Paper: Realmable, Codable {
    ...
    var paperQuestion: [PaperQuestion]? // 在创建时可选
    var random, times: Int
    ...
    required init() {
        ...
        paperComment = nil
        (startTime, endTime, random, times, timeLimit) = (0, 0, 0, 0, 0)
        paperQuestion = []
    }

    required init(id: String, paperName: String, paperComment: String, startTime: Int, endTime: Int, paperType: PaperType, paperQuestion: [PaperQuestion]?, random: Int, times: Int, timeLimit: Int) {
        self.id = id
...
extension Paper {
    convenience init(data: Data) throws {
        ...
        self.init(id: me.id, paperName: me.paperName, paperComment: me.paperComment ?? "", startTime: me.startTime, endTime: me.endTime, paperType: me.paperType, paperQuestion: me.paperQuestion, random: me.random, times: me.times, timeLimit: me.timeLimit)
    }
